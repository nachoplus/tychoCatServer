...
all: astcheck$(EXE) astephem$(EXE) calendar$(EXE) colors$(EXE) colors2$(EXE) \
 ...
 phases$(EXE) ps_1996$(EXE) ssattest$(EXE) tables$(EXE) \
	test_ref$(EXE) testprec$(EXE) uranus1$(EXE) utc_test$(EXE) integrat$(EXE)
...
OBJS= alt_az.o astfuncs.o big_vsop.o classel.o cospar.o date.o delta_t.o \
	...
	showelem.o ssats.o triton.o vsopson.o jpleph.o
...
clean:
	...
	$(RM) ssattest.o tables.o test_ref.o testprec.o uranus1.o utc_test.o integrat.o
...
integrat$(EXE):                integrat.o lunar.a
	$(CC) $(CFLAGS) -o integrat$(EXE) jpleph.o integrat.o lunar.a $(LIBSADDED)
